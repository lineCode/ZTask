...
struct Cookie* curl_cookie_add(struct Curl_easy* data, const char* value, const char* domain, const char* path)
{
    if (!data->cookies)
                                       ...
                                       unless set */
{
    ...
    //   OutputDebugStringA("Curl_cookie_add:");
    //   OutputDebugStringA(lineptr);
    //   OutputDebugStringA("\n");
