#ifndef curl_winldapvc6_h
#define curl_winldapvc6_h
...
#define LDAPAPIFeatureInfo  LDAPAPIFeatureInfoA
    ...
    WINLDAPAPI ULONG LDAPAPI ldap_escape_filter_elementW(
        /*_In_ reads_bytes_(sourceLength)*/ PCHAR   sourceFilterElement,
        ULONG   sourceLength,
...
#define ldap_escape_filter_element ldap_escape_filter_elementW
    ...
    WINLDAPAPI int LDAPAPI
        LdapUTF8ToUnicode(
            /*_In_ reads_(cchSrc)*/ LPCSTR lpSrcStr,
            int cchSrc,
    ...
    WINLDAPAPI
        int LDAPAPI
        LdapUnicodeToUTF8(
            /*_In_ reads_(cchSrc)*/ LPCWSTR lpSrcStr,
            int cchSrc,
...
#define LDAP_OPT_CLIENT_CERTIFICATE    0x80
    ...
    typedef BOOLEAN(_cdecl QUERYCLIENTCERT) (
        ...
        /*IN*/ /*OUT*/ /*PCCERT_CONTEXT*/VOID* *ppCertificate
        );
...
#define LDAP_OPT_SERVER_CERTIFICATE    0x81
    ...
    typedef BOOLEAN(_cdecl VERIFYSERVERCERT) (
        PLDAP Connection,
        /*PCCERT_CONTEXT**/VOID* pServerCert
        );
